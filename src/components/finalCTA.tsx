  ...
  return (
     <section id="contact" className="bg-[#fcfbf7] px-6 py-20 lg:px-10">
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-3xl bg-[#2c2520] px-8 py-20 text-center sm:px-16">
        ...
        <h2 className="relative mx-auto mt-5 max-w-3xl font-serif text-3xl text-[#fcfbf7] sm:text-4xl lg:text-4xl">
          Prêt(e) pour votre <em className="italic text-[#c5a880]">moment d'évasion</em> ?
        </h2>
        ...
        <div className="relative mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          >
            <MessageCircle size={18} /> Nous contacter par WhatsApp
          </a>
        </div>
      </div>
    </section>
